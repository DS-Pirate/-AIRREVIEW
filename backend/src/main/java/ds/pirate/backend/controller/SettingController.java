...
public class SettingController {
  ...
  public ResponseEntity<HashMap<String, Object>> settingArticleList(@RequestBody userid userid) {
    log.info(userid);
    HashMap<String, Object> result = service.settingArticleList(userid.getUserid());
    return new ResponseEntity<>(result, HttpStatus.OK);
  }
